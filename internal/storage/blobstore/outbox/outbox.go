...
func New(db *sql.DB, innerBlobStore blobstore.BlobStore, blobOutboxEntryRepository blobOutboxEntryRepository.BlobOutboxEntryRepository) (*OutboxBlobStore, error) {
