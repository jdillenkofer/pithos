...
func (tr *sqliteRepository) SaveTag(ctx context.Context, tx *sql.Tx, tag *tag.Entity) error {
	if tag.Id == nil {
		id := ulid.Make()
		tag.Id = &id
...
func (tr *sqliteRepository) DeleteTagsByObjectId(ctx context.Context, tx *sql.Tx, objectId ulid.ULID) error {
