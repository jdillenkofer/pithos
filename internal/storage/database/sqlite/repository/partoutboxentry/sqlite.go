...
func (bor *sqliteRepository) FindPartOutboxEntryChunkByIndexWithEntryPresence(ctx context.Context, tx *sql.Tx, outboxId string, id ulid.ULID, chunkIndex int) (*partoutboxentry.ContentChunk, bool, error) {
