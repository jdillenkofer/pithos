...
func (ur *sqliteRepository) FindUserMetadataByObjectIdOrderByKeyAsc(ctx context.Context, tx *sql.Tx, objectId ulid.ULID) ([]usermetadata.Entity, error) {
...
func (ur *sqliteRepository) SaveUserMetadata(ctx context.Context, tx *sql.Tx, userMetadata *usermetadata.Entity) error {
...
func (ur *sqliteRepository) DeleteUserMetadataByObjectId(ctx context.Context, tx *sql.Tx, objectId ulid.ULID) error {
