...
func (br *pgxRepository) FindBucketByName(ctx context.Context, tx *sql.Tx, bucketName string) (*bucket.Entity, error) {
...
func (br *pgxRepository) ExistsBucketByName(ctx context.Context, tx *sql.Tx, bucketName string) (*bool, error) {
...
func (br *pgxRepository) DeleteBucketByName(ctx context.Context, tx *sql.Tx, bucketName string) error {
