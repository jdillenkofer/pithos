...
func (br *pgxRepository) FindBlobsByObjectIdOrderBySequenceNumberAsc(ctx context.Context, tx *sql.Tx, objectId ulid.ULID) ([]blob.Entity, error) {
...
func (br *pgxRepository) SaveBlob(ctx context.Context, tx *sql.Tx, blob *blob.Entity) error {
	if blob.Id == nil {
		id := ulid.Make()
		blob.Id = &id
...
func (br *pgxRepository) DeleteBlobsByObjectId(ctx context.Context, tx *sql.Tx, objectId ulid.ULID) error {
