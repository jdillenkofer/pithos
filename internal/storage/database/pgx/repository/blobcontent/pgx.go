...
func (bcr *pgxRepository) FindBlobContentById(ctx context.Context, tx *sql.Tx, id blobstore.BlobId) (*blobcontent.Entity, error) {
...
func (bcr *pgxRepository) FindBlobContentIds(ctx context.Context, tx *sql.Tx) ([]blobstore.BlobId, error) {
...
func (bcr *pgxRepository) PutBlobContent(ctx context.Context, tx *sql.Tx, blobContent *blobcontent.Entity) error {
...
func (bcr *pgxRepository) SaveBlobContent(ctx context.Context, tx *sql.Tx, blobContent *blobcontent.Entity) error {
...
func (bcr *pgxRepository) DeleteBlobContentById(ctx context.Context, tx *sql.Tx, id blobstore.BlobId) error {
