...
INSERT INTO blob_outbox_entries2 SELECT id, operation, blob_id, content, created_at, updated_at FROM blob_outbox_entries;
...
INSERT INTO storage_outbox_entries2 SELECT id, operation, bucket, key, data, created_at, updated_at, content_type FROM storage_outbox_entries;
