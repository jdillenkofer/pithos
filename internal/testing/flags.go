...
var (
	...
	PartStore           = flag.String("part-store", "sql", "part store to use (sql or filesystem)")
	PartStoreEncryption = flag.String("part-store-encryption", "none", "part store encryption to use (none or tink)")
)
